...
class MenuNotFoundError(BaseError):
    def __init__(self, menu_id: UUID, status_code: int = 404, name: str = "MenuNotFoundError"):
        self.name = name
...
class MenuAlreadyExistsError(BaseError):
    def __init__(self, title: str, status_code: int = 409, name: str = "MenuAlreadyExistsError"):
        self.name = name
